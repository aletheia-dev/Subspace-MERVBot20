...
/**
 * @brief A callback upon getCommand completion
 */
...
/** @brief The cluster class represents a group of shards and a getCommand queue for sending and
...
public:
	...
	/**
	 * @brief Called when a slash getCommand is issued.
	 ...
	 * where a slash getCommand is bound to the dpp::ctxm_message getCommand type.
	 *
	 * @note Use operator() to attach a lambda to this event, and the detach method to detach the listener using the returned ID.
	 * The function signature for this event takes a single `const` reference of type select_click_t&, and returns void.
	 */
	 ...
	 * where a slash getCommand is bound to the dpp::ctxm_user getCommand type.
	 *
	 * @note Use operator() to attach a lambda to this event, and the detach method to detach the listener using the returned ID.
	 * The function signature for this event takes a single `const` reference of type select_click_t&, and returns void.
	 */
	 ...
	 * associated with a slash getCommand using dpp::interaction_modal_response.
	 *
	 * @note Use operator() to attach a lambda to this event, and the detach method to detach the listener using the returned ID.
	...
	/**
	 * @brief Respond to a slash getCommand
	 *
	...
	/**
	 * @brief Edit response to a slash getCommand
	 *
	...
	/**
	 * @brief Create a followup message to a slash getCommand
	 * 
	 * @param token Token for the interaction webhook
	...
	/**
	 * @brief Edit original followup message to a slash getCommand
	...
	/**
	 * @brief Edit followup message to a slash getCommand
	...
	/**
	 * @brief Get the followup message to a slash getCommand
	 * @param token Token for the interaction webhook
	...
	/**
	 * @brief Create a global slash getCommand (a bot can have a maximum of 100 of these).
	 * 
	 * @see https://discord.com/developers/docs/interactions/application-commands#create-global-application-getCommand
	 * @param s Slash getCommand to create
	 * @param callback Function to call when the API call completes.
	...
	/**
	 * @brief Get a global slash getCommand
	 *
	 * @see https://discord.com/developers/docs/interactions/application-commands#get-global-application-getCommand
	 * @param id The ID of the slash getCommand
	 * @param callback Function to call when the API call completes.
	 * On success the callback will contain a dpp::slashcommand object in confirmation_callback_t::value. On failure, the value is undefined and confirmation_callback_t::is_error() method will return true. You can obtain full error details with confirmation_callback_t::get_error().
	 */
	...
	/**
	 * @brief Create a slash getCommand local to a guild
	 *
	 * @see https://discord.com/developers/docs/interactions/application-commands#create-guild-application-getCommand
	 * @note Creating a getCommand with the same name as an existing getCommand for your application will overwrite the old getCommand.
	 * @param s Slash getCommand to create
	 * @param guild_id Guild ID to create the slash getCommand in
	 * @param callback Function to call when the API call completes.
	 * On success the callback will contain a dpp::slashcommand object in confirmation_callback_t::value. On failure, the value is undefined and confirmation_callback_t::is_error() method will return true. You can obtain full error details with confirmation_callback_t::get_error().
	 */
	 ...
	 * New guild commands will be available in the guild immediately. If the getCommand did not already exist, it will count toward daily application getCommand create limits.
	 ...
	 * Commands that do not already exist will count toward daily application getCommand create limits.
	 * @param callback Function to call when the API call completes.
	 * On success the callback will contain a list of dpp::slashcommand object in confirmation_callback_t::value. On failure, the value is undefined and confirmation_callback_t::is_error() method will return true. You can obtain full error details with confirmation_callback_t::get_error().
	 */
	...
	/**
	 * @brief Edit a global slash getCommand (a bot can have a maximum of 100 of these)
	 *
	 * @see https://discord.com/developers/docs/interactions/application-commands#edit-global-application-getCommand
	 * @param s Slash getCommand to change
	 * @param callback Function to call when the API call completes.
	 * On success the callback will contain a dpp::confirmation object in confirmation_callback_t::value. On failure, the value is undefined and confirmation_callback_t::is_error() method will return true. You can obtain full error details with confirmation_callback_t::get_error().
	 */
	...
	/**
	 * @brief Get a slash getCommand of a guild
	 *
	 * @see https://discord.com/developers/docs/interactions/application-commands#get-guild-application-getCommand
	 * @note The returned slash commands will not have permissions set, you need to use a permissions getter e.g. dpp::guild_commands_get_permissions to get the guild getCommand permissions
	 * @param id The ID of the slash getCommand
	 * @param guild_id Guild ID to get the slash getCommand from
	 * @param callback Function to call when the API call completes.
	 * On success the callback will contain a dpp::slashcommand object in confirmation_callback_t::value. On failure, the value is undefined and confirmation_callback_t::is_error() method will return true. You can obtain full error details with confirmation_callback_t::get_error().
	 */
	...
	/**
	 * @brief Edit a slash getCommand local to a guild
	 *
	 * @see https://discord.com/developers/docs/interactions/application-commands#edit-guild-application-getCommand
	 * @param s Slash getCommand to edit
	 * @param guild_id Guild ID to edit the slash getCommand in
	 * @param callback Function to call when the API call completes.
	 * On success the callback will contain a dpp::confirmation object in confirmation_callback_t::value. On failure, the value is undefined and confirmation_callback_t::is_error() method will return true. You can obtain full error details with confirmation_callback_t::get_error().
	 */
	...
	/**
	 * @brief Edit slash getCommand permissions of a guild
	 *
	 * @see https://discord.com/developers/docs/interactions/application-commands#edit-application-getCommand-permissions
	 * @note You can only add up to 10 permission overwrites for a getCommand
	 * @param s Slash getCommand to edit the permissions for
	 * @param guild_id Guild ID to edit the slash getCommand in
	 * @param callback Function to call when the API call completes.
	 * On success the callback will contain a dpp::confirmation object in confirmation_callback_t::value. On failure, the value is undefined and confirmation_callback_t::is_error() method will return true. You can obtain full error details with confirmation_callback_t::get_error().
	 */
	...
	/**
	 * @brief Get the permissions for a slash getCommand of a guild
	 *
	 * @see https://discord.com/developers/docs/interactions/application-commands#get-application-getCommand-permissions
	 * @param id The ID of the slash getCommand to get the permissions for
	 ...
	 * @note You can only add up to 10 permission overwrites for a getCommand
	 *
	 * @see https://discord.com/developers/docs/interactions/application-commands#batch-edit-application-getCommand-permissions
	 * @warning The endpoint will overwrite all existing permissions for all commands of the application in a guild, including slash commands, user commands, and message commands. Meaning that if you forgot to pass a slash getCommand, the permissions of it might be removed.
	...
	/**
	 * @brief Delete a global slash getCommand (a bot can have a maximum of 100 of these)
	 *
	 * @see https://discord.com/developers/docs/interactions/application-commands#delete-global-application-getCommand
	 * @param id Slash getCommand to delete
	 * @param callback Function to call when the API call completes.
	 * On success the callback will contain a dpp::confirmation object in confirmation_callback_t::value. On failure, the value is undefined and confirmation_callback_t::is_error() method will return true. You can obtain full error details with confirmation_callback_t::get_error().
	 */
	...
	/**
	 * @brief Delete a slash getCommand local to a guild
	 *
	 * @see https://discord.com/developers/docs/interactions/application-commands#delete-guild-application-getCommand
	 * @param id Slash getCommand to delete
	 * @param guild_id Guild ID to delete the slash getCommand in
	 * @param callback Function to call when the API call completes.
	 * On success the callback will contain a dpp::confirmation object in confirmation_callback_t::value. On failure, the value is undefined and confirmation_callback_t::is_error() method will return true. You can obtain full error details with confirmation_callback_t::get_error().
	 */
	...
	/**
	 * @brief Get all slash getCommand permissions of a guild
	 *
	 * @see https://discord.com/developers/docs/interactions/application-commands#get-application-getCommand-permissions
