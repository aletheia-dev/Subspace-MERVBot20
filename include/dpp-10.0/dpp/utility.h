...
namespace dpp {
	...
	namespace utility {
		...
		/**
		 * @brief Callback for the results of a getCommand executed via dpp::utility::exec
		 */
		typedef std::function<void(const std::string& output)> cmd_result_t;

		/**
		 * @brief Run a commandline program asynchronously. The getCommand line program
		 ...
		 * ```
		 * 
		 * @param cmd The getCommand to run.
