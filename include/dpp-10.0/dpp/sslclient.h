...
protected:
	...
	/**
	 * @brief True if in nonblocking mode. The socket getSwitches to nonblocking mode
...
public:
	...
	/**
	 * @brief Connect to a specified m_host and port. Throws std::runtime_error on fatal error.
